...
final_test_data = load_dataset(
    "data/final_test_transactions.json"
)


# ---------------------------------------------------------
# TRAIN ML ONLY ON TRAINING DATA
# ---------------------------------------------------------
...
print(
    "\nSentinelPay Final Synthetic Test"
)
